...
class ApiTests(unittest.TestCase):
    ...
    def test_main_page_has_testing_guide_preview_help_and_editors(self):
        ...
        self.assertNotIn(b"TotalEnergies", response.data)
        self.assertNotIn(b"Quartz Engine Oil", response.data)
        ...
        guide = self.client.get("/static/AI-DEMO-GUIDE.html")
        self.assertEqual(guide.status_code, 200)
        self.assertIn(b"Run the AI demonstration", guide.data)
        guide.close()
    ...
    def test_overlay_pages_are_available(self):
        ...
        self.assertIn(b"IROC Challenge Series", overlay.data)
        self.assertNotIn(b"TotalEnergies", overlay.data)
